...
export const translations = {
  zh: {
    ...
    footer: '資料來源：臺北市公開資料中的1999市民服務案件、派工或維修相關資料、公共工程施工查核紀錄與其他市政服務背景資料。資料僅供資料探索、歷史趨勢觀察與市政服務背景分析使用，不構成即時案件狀態、即時施工進度、工程完成狀態、建物安全判定、施工安全保證、法律責任認定、採購違失判定或公共安全警示。最新與正式資訊請以臺北市政府、各主管機關、1999市民熱線、採購公告及官方系統為準。',
  ...
  en: {
    ...
    footer: 'Data sources: Taipei public-data records related to 1999 citizen-service cases, dispatch or repair-related records, public works construction audit records, and other civic-service context data. The data is for data exploration, historical trend observation, and civic-service context analysis only and does not constitute real-time case status, real-time construction progress, project completion status, building-safety determination, construction-safety guarantee, legal liability determination, procurement violation determination, or public-safety alerts. Latest and official information should be verified with Taipei City Government, competent authorities, the 1999 citizen hotline, procurement announcements, and official systems.',
